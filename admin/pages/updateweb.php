...
<div style="width:80%" class="container bg-dark p-5 m-5  shadow ">
    <form action="#" method="POST" enctype="multipart/form-data">
        <div class="d-flex justify-content-between p-3 mb-5 border-bottom">
            <h1 class="text-white">Edit Web <span style="font-size:5rem; font-weight:100; margin-right:-13px;  position:relative; top:20px;">/</span><span style="font-size:5rem;font-weight:100; position:relative; color:aqua; top:20px;">/</span> <span style="color:aqua; "> ADMIN</span></h1>
...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $query1 = "SELECT * FROM webs WHERE id ='$id'";
    ...
    $data1 = mysqli_fetch_assoc($result1);
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (
                ...
                $query = "UPDATE 
                        webs SET name='$name',image='$image' WHERE id='$id'";

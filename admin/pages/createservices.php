...
<div style="width:80%" class="container bg-dark p-3  m-5  shadow ">
    <form action="#" method="POST" enctype="multipart/form-data">
        <div class="d-flex justify-content-between p-3 mb-2 border-bottom">
            <h1 class="text-white">Services Section <span style="font-size:5rem; font-weight:100; margin-right:-13px;  position:relative; top:20px;">/</span><span style="font-size:5rem;font-weight:100; position:relative; color:aqua; top:20px;">/</span> <span style="color:aqua; "> ADMIN</span></h1>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (
                 $logo != "" && $title != "" && $detail != "" ) {
                        $query = "INSERT INTO 
                        services( logo,title,detail)
                        VALUES('$logo','$title','$detail')";
        ...
        <div class="mb-3 d-flex flex-column">
            ...
            <div class="d-flex">
                <input type="text" class="form-control h-50 w-75 me-1 mt-1" id="imgbox" readonly name="logo">
